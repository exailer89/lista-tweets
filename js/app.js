...
function crearHTML() {
    ...
    if (tweets.length > 0) {
        tweets.forEach( tweet => {
            ...
            // Añadir función de eliminar al boton Eliminar
            btnEliminar.onclick = () => {
...
function borrarTweet(id) {
    tweets = tweets.filter(tweet => tweet.id !== id); // Al arreglo tweets le asignamos todos menos el que estamos seleccionando.
